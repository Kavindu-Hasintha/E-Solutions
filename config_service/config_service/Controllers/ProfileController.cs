...
namespace config_service.Controllers
{
    ...
    public class ProfileController : ControllerBase
    {
        ...
        {
            string q = @"select pro_id, pro_first_name, pro_last_name, pro_email, pro_mobile, PhotoLink from profile where pro_desig_id = 2";
            DataTable table = new DataTable();
            string sqlDataSource = _configuration.GetConnectionString("ConfigDBConnecion");
            SqlDataReader myReader;
            using (SqlConnection myCon = new SqlConnection(sqlDataSource))
        ...
        {
            string q = @"select pro_id, pro_first_name, pro_last_name, pro_email, pro_mobile, PhotoLink from profile where pro_desig_id = 3";
            DataTable table = new DataTable();
            string sqlDataSource = _configuration.GetConnectionString("ConfigDBConnecion");
            SqlDataReader myReader;
            using (SqlConnection myCon = new SqlConnection(sqlDataSource))
        ...
        // Get Total Users (2023/06/07)
        [HttpGet]
        [Route("GetTotalUsers")]
        public JsonResult GetTotalUsers()
        {
            string q = @"select count(*) from profile";
            DataTable table = new DataTable();
            string sqlDataSource = _configuration.GetConnectionString("ConfigDBConnecion");
            SqlDataReader myReader;
            using (SqlConnection myCon = new SqlConnection(sqlDataSource))
        ...
        // Get Total Admins (2023/06/07)
        [HttpGet]
        [Route("GetTotalAdmins")]
        public JsonResult GetTotalAdmins()
        {
            string q = @"select count(*) from profile where pro_desig_id = 2";
            DataTable table = new DataTable();
            string sqlDataSource = _configuration.GetConnectionString("ConfigDBConnecion");
            SqlDataReader myReader;
            using (SqlConnection myCon = new SqlConnection(sqlDataSource))
        ...
        // Get Total Partners (2023/06/07)
        [HttpGet]
        [Route("GetTotalPartners")]
        public JsonResult GetTotalPartners()
        {
            string q = @"select count(*) from profile where pro_desig_id = 3";
            DataTable table = new DataTable();
            string sqlDataSource = _configuration.GetConnectionString("ConfigDBConnecion");
            SqlDataReader myReader;
            using (SqlConnection myCon = new SqlConnection(sqlDataSource))
        ...
        // Delete an account (2023/06/09)
        [HttpDelete]
        [Route("DeleteAccount")]
        public JsonResult DeleteAccount(int id)
        {
            string q = @"DELETE FROM profile WHERE pro_id = @id";
            string r = @"DELETE FROM login WHERE pro_id = @id";
            DataTable table = new DataTable();
            string sqlDataSource = _configuration.GetConnectionString("ConfigDBConnecion");
            SqlDataReader myReader;
            using (SqlConnection myCon = new SqlConnection(sqlDataSource))
            {
                myCon.Open();
                using (SqlCommand myCommand = new SqlCommand(r, myCon))
                {
                    myCommand.Parameters.AddWithValue("@id", id);
