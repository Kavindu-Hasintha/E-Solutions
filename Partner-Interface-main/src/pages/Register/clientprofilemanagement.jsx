...
const ClientProfileManagment = () => {
  return (
    <article
      className="br3  ba b--black-10 mv4 w-100 w-100-m w-25-l mw7 shadow-1 center"
      style={{ Color: "silver" }}
    >
          ...
          <div>
            ...
            >
              ...
              <tr>
                ...
                <td>
                  <select
                    placeholder="Assign to Partner"
                    style={{ width: "285px", height: "40px", color: "grey" }}
                    className="inputtags"
                  >
                    <option value="None">None</option>
                    <option value="Pravindu Bhashitha">
                      Pravindu Bhashitha
                    </option>
                    <option value="Tharindu Ruwanpathirana">
                      Tharindu Ruwanpathirana
              ...
              <tr>
                ...
                <td>
                  <button className="b ph3 pv2 input-reset ba b--black bg-red grow pointer f6 dib">
                    Disable
                  </button>
                </td>
              </tr>
